...
{ IProject 
	...
	- Subsystems = { IRPYRawContainer 
		...
		{ ISubsystem 
			- fileName = "Engine";
			- _id = GUID 78931d1d-1e28-48a4-b673-cb047ac1abc3;
		}
		{ ISubsystem 
			- fileName = "engine_1";
	...
	- Diagrams = { IRPYRawContainer 
		...
		{ IDiagram 
			...
			- _name = "Model";
			- _lastModifiedTime = "1.9.2011::0:32:4";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIClass 
					- _id = GUID f5fa3359-3490-4b8b-8cd8-81e76a64dc5a;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.216909 0 0 0.248411 124.861 55.9297 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=PrimitiveOperationListCompartment>";
				...
				{ CGIClass 
					- _id = GUID 8dfa98ae-df9f-4408-81fb-c5c8ee9de4d6;
					- m_type = 87;
					- m_pModelObject = { IHandle 
						- _m2Class = "IClass";
						- _filename = "engine_1.sbs";
						- _subsystem = "engine";
						- _class = "";
						- _name = "EngineController";
						- _id = GUID 142fb4ea-6032-4120-80d8-86114caae6f0;
					}
					- m_pParent = GUID 5ed86b69-8688-4fae-9bda-fc8300ee2abe;
					- m_name = { CGIText 
						- m_str = "EngineController";
						- m_style = "Arial" 10 0 0 0 1 ;
						- m_color = { IColor 
							- m_fgColor = 0;
							- m_bgColor = 0;
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.185055 0 0 0.262212 487.958 429.324 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=PrimitiveOperationListCompartment>";
				...
				{ CGIClass 
					- _id = GUID 8996af45-9356-4066-8fad-f04a0aa4e845;
					- m_type = 87;
					- m_pModelObject = { IHandle 
						- _m2Class = "IClass";
						- _filename = "engine_1.sbs";
						...
						- _class = "";
						- _name = "Throttle";
						- _id = GUID b8abb1da-6474-447e-8106-6bfbddd67f09;
					}
					- m_pParent = GUID 5ed86b69-8688-4fae-9bda-fc8300ee2abe;
					- m_name = { CGIText 
						- m_str = "Throttle";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.127415 0 0 0.262212 782.033 52.5395 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=PrimitiveOperationListCompartment>";
				...
				{ CGIClass 
					- _id = GUID 97573934-c0d3-43a8-8575-8423afc0bf54;
					- m_type = 87;
					- m_pModelObject = { IHandle 
						- _m2Class = "IClass";
						- _filename = "engine_1.sbs";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.134999 0 0 0.262212 822.177 687.396 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=PrimitiveOperationListCompartment>";
				...
				{ CGIClass 
					- _id = GUID 11247e3c-7e6b-4355-a21d-8ab984eef8cd;
					- m_type = 87;
					- m_pModelObject = { IHandle 
						- _m2Class = "IClass";
						- _filename = "engine_1.sbs";
						...
						- _class = "";
						- _name = "SparkPlug";
						- _id = GUID a26a9003-11fb-4f3e-b32c-c8dc0fc33dbe;
					}
					- m_pParent = GUID 5ed86b69-8688-4fae-9bda-fc8300ee2abe;
					- m_name = { CGIText 
						- m_str = "SparkPlug";
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.127415 0 0 0.262212 161.986 542.876 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
...
<frame name=PrimitiveOperationListCompartment>";
				...
				{ CGIAssociationEnd 
					- _id = GUID a9798663-30c4-44d9-a9f5-32830dd94185;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_pModelObject = { IHandle 
						...
						- _filename = "engine_1.sbs";
						- _subsystem = "engine";
						- _class = "EngineController";
						- _name = "itsEngine";
						- _id = GUID 10485cea-7bea-43d9-9a89-7eb58b203945;
					}
					- m_pParent = ;
					- m_name = { CGIText 
						- m_str = "";
					...
					- m_drawBehavior = 0;
					- m_bIsPreferencesInitialized = 1;
					- m_pSource = GUID 8dfa98ae-df9f-4408-81fb-c5c8ee9de4d6;
					- m_sourceType = 'F';
					- m_pTarget = GUID f5fa3359-3490-4b8b-8cd8-81e76a64dc5a;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "";
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 349 477 ;
					- m_TargetPort = 1046 978 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "IAssociationEnd";
						- _filename = "engine_1.sbs";
						- _subsystem = "engine";
						- _class = "Engine";
						- _name = "itsEngineController";
						- _id = GUID bf503f80-ec42-44ca-b68d-7643a7a0d0a9;
					}
				...
				{ CGIAssociationEnd 
					...
					- m_pSource = GUID 8dfa98ae-df9f-4408-81fb-c5c8ee9de4d6;
					- m_sourceType = 'F';
					- m_pTarget = GUID 11247e3c-7e6b-4355-a21d-8ab984eef8cd;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "";
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 176 1018 ;
					- m_TargetPort = 620 585 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "IAssociationEnd";
						- _filename = "engine_1.sbs";
						- _subsystem = "engine";
				...
				{ CGIAssociationEnd 
					...
					- m_pSource = GUID 8dfa98ae-df9f-4408-81fb-c5c8ee9de4d6;
					- m_sourceType = 'F';
					- m_pTarget = GUID 97573934-c0d3-43a8-8575-8423afc0bf54;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "";
					...
					- m_arrow = 2 458 277  458 351  ;
					- m_anglePoint1 = 0 0 ;
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 775 841 ;
					- m_TargetPort = 573 585 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "IAssociationEnd";
						- _filename = "engine_1.sbs";
						- _subsystem = "engine";
				...
				{ CGIAssociationEnd 
					...
					- m_drawBehavior = 0;
					- m_bIsPreferencesInitialized = 1;
					- m_pSource = GUID 8996af45-9356-4066-8fad-f04a0aa4e845;
					- m_sourceType = 'F';
					- m_pTarget = GUID 8dfa98ae-df9f-4408-81fb-c5c8ee9de4d6;
					- m_targetType = 'T';
					- m_direction = ' ';
					- m_rpn = { CGIText 
						- m_str = "";
					...
					- m_anglePoint2 = 0 0 ;
					- m_line_style = 2;
					- m_SourcePort = 216 1284 ;
					- m_TargetPort = 462 713 ;
					- m_pInverseModelObject = { IAssociationEndHandle 
						- _m2Class = "IAssociationEnd";
						- _filename = "engine_1.sbs";
						- _subsystem = "engine";
	...
	- UCDiagrams = { IRPYRawContainer 
		...
		{ IUCDiagram 
			...
			- _lastModifiedTime = "1.9.2011::0:5:26";
			- _graphicChart = { CGIClassChart 
